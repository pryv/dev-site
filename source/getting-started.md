...
In addition, you can download the [OpenAPI document](/open-api/3.0/api.yaml) describing Pryv.io API using OpenAPI Specification and import it on other testing platforms for API such as Postman, as explained on our [Open API page](/source/open-api/index.md).
