...
Using a `pryvApiEndpoint` to load an app allows to load data directly as it ususally contains credentials. For cases where you require authentication, it is preferred to use `pryvServiceInfoUrl`:
