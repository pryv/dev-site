...
If the request yields an answer, your firewall settings might be set wrong. You must allow INGRESS UDP/53 as defined in the **Infrastructure procurement guide** from the [Customer Resources page](/customer-resources/#documents).
