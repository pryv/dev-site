...
The code for the Desktop and Mobile version is available in our [Github repositery](https://github.com/pryv/app-web-examples/tree/release/hf-example/hf-data).
