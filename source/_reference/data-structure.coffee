...
module.exports = exports =
  ...
  ,
    ...
    description: """
                 A string uniquely identifying an item for a given user. For some types of items ("structural" ones such as streams), the identifier can be optionally set by API clients; otherwise it is generated by the server.
                 """
    examples: []
